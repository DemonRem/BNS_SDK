...
{
	TArray< float >                                    RequiredKeyInTimes;                               		// 0x0000 (0x000C) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
	TArray< struct FPresetGeneratedPoint >             GeneratedPoints;                                  		// 0x000C (0x000C) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
...
{
	struct FString                                     OutName;                                          		// 0x0000 (0x000C) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
};
...
{
	struct FString                                     ReturnValue;                                      		// 0x0000 (0x000C) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
	// struct FString                                  retval;                                           		// 0x000C (0x000C) [0x0000000000000000]              
};
...
{
	TArray< struct FPresetGeneratedPoint >             GeneratedPoints;                                  		// 0x0000 (0x000C) [0x0000000000000080]              ( CPF_Parm )
	unsigned long                                      ReturnValue : 1;                                  		// 0x000C (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
	// unsigned long                                   bRetval : 1;                                      		// 0x0010 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	TArray< struct FUIStateResourceInfo >              out_SupportedStates;                              		// 0x0000 (0x000C) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
